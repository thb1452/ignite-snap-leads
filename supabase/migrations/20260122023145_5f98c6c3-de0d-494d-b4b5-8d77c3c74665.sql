...
-- Fix: When user has NO subscription OR no states selected, show ALL properties
-- Also: Use case-insensitive state matching for consistency
...
BEGIN
  ...
  -- 1. No subscription (new users can browse)
  -- 2. Enterprise plan (max_states = 0 means unlimited)
  -- 3. User hasn't selected states yet (let them see data first)
...
-- Also fix fn_properties_by_bbox
