          ...
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route
                ...
                element={<HowInvestorsFindDistressedProperties />}
              />
              ...
              />
              <Route
                path="/foia/admin/press-accounts"
                element={
                  <FoiaAuthGuard requiredRole="admin">
