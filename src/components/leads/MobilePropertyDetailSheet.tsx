...
export function MobilePropertyDetailSheet({ property, open, onOpenChange }: MobilePropertyDetailSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent 
        side="bottom" 
        className="h-[90dvh] rounded-t-3xl p-0 flex flex-col [&>button]:hidden"
      >
        {/* Drag Handle */}
        ...
        {/* Header */}
        <div className="px-5 pt-2 pb-4 border-b flex-none">
          <div className="flex items-start gap-3 pr-10">
            ...
            <Badge className={`${getScoreColor(property.snap_score)} text-base font-bold px-3 py-1.5 flex-none`}>
        ...
        {/* Content - Scrollable */}
        <div className="flex-1 min-h-0 overflow-y-auto px-5 py-5 space-y-5 overscroll-contain touch-pan-y">
          {/* Property Image */}
          {property.photo_url ? (
        ...
        <div className="border-t p-4 bg-background space-y-3 pb-[calc(env(safe-area-inset-bottom)+16px)] flex-none">
