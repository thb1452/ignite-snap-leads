...
import { LogOut, FileText, Users, Database, RotateCw, Newspaper, ClipboardList, BarChart2 } from 'lucide-react';
...
export function FoiaNavbar() {
  ...
  const adminLinks = [
    ...
    { href: '/foia/admin/intelligence', label: 'Intelligence', icon: BarChart2 },
  ];
