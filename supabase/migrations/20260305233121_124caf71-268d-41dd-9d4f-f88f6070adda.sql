...
DROP FUNCTION IF EXISTS public.fn_properties_by_category(text, text, text, text, integer, integer, integer, integer, integer);
DROP FUNCTION IF EXISTS public.fn_properties_by_category(text, text, text, text, integer, integer, integer, integer, integer, text);
...
-- Recreate with water_disconnection support
