          ...
          <form onSubmit={mode === 'login' ? handleLogin : handleSignup} className="space-y-4">
            {mode === 'signup' && (
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-white placeholder-slate-400 text-sm focus:outline-none focus:border-blue-500"
                />
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                required
                disabled={mode === 'signup' && !!token && inviteValid === true}
                className="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-white placeholder-slate-400 text-sm focus:outline-none focus:border-blue-500 disabled:opacity-60"
              />
            </div>
            ...
            {error && (
              <p className="text-red-400 text-sm bg-red-900/30 rounded-lg p-2">{error}</p>
            )}
