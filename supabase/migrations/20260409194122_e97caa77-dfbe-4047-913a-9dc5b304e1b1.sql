-- Drop BOTH overloaded signatures explicitly
DROP FUNCTION IF EXISTS public.fn_properties_paged(
  integer, integer, text, text, text, integer, integer, integer, text, boolean, boolean, boolean, text
);
DROP FUNCTION IF EXISTS public.fn_properties_paged(
  integer, integer, text, text, text, integer, integer, text, boolean, boolean, boolean, integer, text
);
